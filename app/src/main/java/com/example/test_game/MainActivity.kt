...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val view: kotlin.collections.ArrayList<View> = arrayListOf(
            viev_javob, viev_javob2, viev_javob3, viev_javob4,
            viev_javob5, viev_javob6, viev_javob7, viev_javob8, viev_javob9, viev_javob10
        )
        var viewIndex = 0
        btn_keyingi.setOnClickListener {
            ...
            if (radBtnChekedJavob == radBtnJavob) {
                Toast.makeText(this, "tori javob", Toast.LENGTH_SHORT).show()
                view[viewIndex].setBackgroundResource(R.drawable.fon_javob_1)
                viewIndex++
            }else{
                Toast.makeText(this, "notori javob", Toast.LENGTH_SHORT).show()
